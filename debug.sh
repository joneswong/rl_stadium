CUDA_VISIBLE_DEVICES="" python main.py --ps_hosts="localhost:8167" --worker_hosts="localhost:8169,localhost:8171" --job_name="worker" --task_index=0 --config="examples/pendulum.json" &

CUDA_VISIBLE_DEVICES="" python main.py --ps_hosts="localhost:8167" --worker_hosts="localhost:8169,localhost:8171" --job_name="worker" --task_index=1 --config="examples/pendulum.json" &
