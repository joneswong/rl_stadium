...
def main(_):
    ...
    if is_learner:
        ...
        os.system("mkdir tmp")
        os.system("osscmd --host=oss-cn-hangzhou-zmf.aliyuncs.com --id=LTAI7wU9Qj3OQo0t --key=JHIACB8W1vu6ZFFF6V6k1ZrqrG4I8k downloadallobject oss://142534/nips18/contd_start_from/ tmp")
