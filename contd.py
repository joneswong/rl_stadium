...
def get_env(env_name):
    ...
    if env_name == "pendulum":
        ...
        return wrap_round2_opensim(env, skip=AGENT_CONFIG.get("skip", 3), use_hcf=AGENT_CONFIG.get("use_hcf", False), clean=AGENT_CONFIG.get("clean", False))
    elif env_name == "sr":
...
def main(_):
    ...
    if is_learner:
        ...
        os.system("mkdir tmp")
        os.system("osscmd --host=oss-cn-hangzhou-zmf.aliyuncs.com --id=" + access_id + " --key=" + access_key + " downloadallobject oss://142534/nips18/contd_start_from/ tmp")
